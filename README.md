...
Pluralsight tutorial portion of this project was completed on September 10.
The following items are personal improvements that will be done next:

- Add a start page so that the user can select a topic and the number of questions.
- Use [trivia_api](https://opentdb.com/api_config.php) instead of prepopulated json file:
- Track scoring on each question and on the QuizEnd component.
